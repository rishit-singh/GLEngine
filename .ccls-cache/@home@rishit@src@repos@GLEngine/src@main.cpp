...
{	
	...
	GLEngine::Shader shader = GLEngine::Shader(FileIO::Read("shaders/vertexshader_ut.vert"), 
							FileIO::Read("shaders/fragmentshader_ut.frag"), true);
	...
	std::vector<float> vb = OBJLoader::LoadOBJFile(argv[1]);
